...
- **Breaking** `run() ->!` has been replaced by `run() -> Result<(), ExternalError>` for returning errors without calling `std::process::exit()` ([#2767](https://github.com/rust-windowing/winit/pull/2767))
