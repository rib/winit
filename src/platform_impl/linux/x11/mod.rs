...
pub struct EventLoop<T: 'static> {
    ...
    redraw_receiver: PeekableReceiver<WindowId>, //waker.ping() needs to be called whenever something gets sent
    user_receiver: PeekableReceiver<T>, //waker.ping() needs to be called whenever something gets sent
